...
def table_selector():
    ...
    table1 = ["Egg Benedict","Biscuit and Gravy", "Steak and Eggs", "Coffee", "Coffee", "Soft Drink"]
    table2 = ["Steak Salad","Soft Drink","Soup of the Day","Chicken Wrap","Water","Chicken Fingers","Soft Drink","Chef Special"]
    ...
    if table_select == 1:
        ...
        table = table2
    return table
#This is the dictionary we are given
menu = {
    "Brunch" : {
